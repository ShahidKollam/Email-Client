...
const BulkMailDoc = () => {
  ...
  const apiUrl = "http://localhost:3001/api/client/send-email-to-client"
  ...
  const requestCode = `  
  const payload = { recipients, templateId };
  ...
  return (
    <div className="bg-gray-900 text-white font-sans max-w-[90vw] overflow-y-auto">
      <div className="container mx-auto px-6 py-16">
        <h1 className="text-5xl font-extrabold text-indigo-400 text-center mb-8">Bulk Email API Integration Guide</h1>

        <p className="text-xl text-gray-300 text-center mb-12">
          Learn how to integrate the <strong>TemplatePro API</strong> into your app to send bulk emails seamlessly.
        </p>
        ...
        <div className="bg-gray-800 p-8 rounded-lg shadow-xl mb-12">
          ...
          <p className="text-xl text-gray-300 mb-4">
            To send emails to multiple recipients using the TemplatePro API, use the endpoint provided below. This URL
            is used for the POST request to TemplatePro. Copy the URL below and use it in your API request.
          </p>
          ...
          <p className="text-xl text-gray-300 mb-4">
            ...
            payload to the TemplatePro API, which will send an email to each recipient. The payload includes the email
            recipients and the template ID. For bulk emails, you can specify multiple recipients' email IDs and names in
            the "recipients" array.
          </p>
          <p className="text-xl text-gray-300 mb-4">
            You can retrieve the template ID from the API by making a GET request to the TemplatePro templates endpoint.
            You need to fetch the template IDs before using them in the request.
          </p>
          <p className="text-xl text-gray-300 mb-4">
          ...
          <p className="text-xl text-gray-300 mb-4">
            Here's an example that combines the API URL, headers, and payload to send emails in bulk. Copy the full code
